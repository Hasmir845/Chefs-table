...
export default function Banner() {
  return ( 
    ...
    >
        <div className=" flex items-center text-center flex-col w-9/12 mx-auto text-white space-y-10 md:space-y-16">
        <h1 className=" text-white text-4xl md:text-5xl text-center font-bold mt-10 md:mt-40">Discover an exceptional cooking class tailored for you</h1>
        ...
        <div className=" my-5 flex justify-center gap-5 md:mt-10">
